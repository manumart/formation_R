...
========================================================
 ...
 1. **S3** : le plus simple, utilisé dans les pacakges de base `base` et `stats`, et c'est le plus couramment rencontré sur le CRAN - Exemple des fonctions `generic.class()`
